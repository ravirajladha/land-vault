...
(function($) {
  ...
  $('#dynamic-option-creation1').select2({
      tags: true
  });
  $('#dynamic-option-creation2').select2({
      tags: true
  });
  $('#dynamic-option-creation3').select2({
      tags: true
  });
  $('#dynamic-option-creation4').select2({
      tags: true
  });
  $('#dynamic-option-creation5').select2({
      tags: true
  });
  $('#dynamic-option-creation6').select2({
      tags: true
  });
  $('#dynamic-option-creation7').select2({
      tags: true
  });
  $('#dynamic-option-creation8').select2({
      tags: true
  });
  $('#dynamic-option-creation9').select2({
      tags: true
  });
  $('#dynamic-option-creation10').select2({
      tags: true
  });
