                                ...
                                <form action="{{ url('/') }}/child-filter-document" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <select id="single-select-abc2" class="form-select form-control"
                                                ...
                                                @php
                                                    $selectedType = old('type', $filters['type'] ?? '');
                                                @endphp


                                                @foreach ($doc_type as $index => $item)
                                                    <option value="{{ $item->id }}" 
                                                        {{ $selectedType == $item->id || (empty($selectedType) && $index == 0) ? 'selected' : '' }}>
                                            ...
                                            <select id="single-select-abc7" class="form-select form-control"
                                                ...
                                                @foreach ($survey_nos as $survey_no)
                                                    <option value="{{ $survey_no }}"
                                                        {{ old('survey_no', $filters['survey_no'] ?? '') == $survey_no ? 'selected' : '' }}>
                                    ...
                                    <div class="card-footer">
                                        <div class="text-end">
                                            ...
                                            <a href="{{ url('/') }}/child-document-reports" class="btn btn-dark"><i
